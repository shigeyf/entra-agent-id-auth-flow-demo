...
> [Getting Started](getting-started.ja.md) を参照してください。このドキュメントは
> Getting Started のセクション 1〜7 が完了済みの環境を前提としています。

## 前提条件

- [Getting Started](getting-started.ja.md) のセクション 1〜7 が完了していること
...
- [Getting Started](getting-started.ja.md) — 初回セットアップ・ローカル起動
- [Architecture](architecture.ja.md) — コンポーネント構成詳細
- [Hosted Agent の詳細](../src/agent/README.ja.md) — Agent のアーキテクチャ・デプロイライフサイクル
