...
インフラのデプロイ手順は [Getting Started](../../docs/getting-started.md) のセクション 2～4 を参照してください。
...
- [Getting Started](../../docs/getting-started.md) — セットアップ手順 (セクション 5: Entra Agent ID、セクション 6: Hosted Agent デプロイ)
- [Entra Agent ID 概要](../../docs/entra-agent-id-overview.md) — 3 フローの概念と Blueprint / Agent Identity の階層
- [Architecture](../../docs/architecture.md) — システム全体の構成図
- [再デプロイ・運用リファレンス](../../docs/deployment.md) — Agent の再デプロイ手順
